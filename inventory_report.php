                                 ...
                                 . $row["product_name"]. "</p></td><td>"
                                  . $row["product_unitprice"]. "</td><td>"
                                   . $product_availability. "</td>
																	 <td align='center'> <a href='addproduct.php'>
 																	Add</a> <br><a href='editproduct.php?product_id=",urlencode($row["product_id"]),"'>
																 Edit</a> <br><a href='deleteproduct.php?product_id=",urlencode($row["product_id"]),"' onclick='return confirm(\"Are you sure to delete?\");'>
																Delete</a> <br><a href='change_availability.php?product_name=",urlencode($row["product_name"]),"&product_availability=",urlencode($row["product_availability"]),"' onclick='return confirm(\"Are you sure to change the availability?\");'>
