<?php
		...
		foreach($_POST["search"] as $k=>$v){
			if(!empty($v)) {
				...
				switch($k) {
					case "fullName":
						$fullName = $v;
						$queryCondition .= "fullName LIKE '" . $v . "%'";
						break;
				}
			}
		}
	...
	$sql = "SELECT * FROM contactus " . $queryCondition;
	$href = 'feedback.php';
...
<body>
  ...
  <div class="main_body_content">
    ...
    <div id="toys-grid">
			<form name="frmSearch" method="post" action="feedback.php">
			<div class="search-box">
			<p><input type="text" placeholder="Name" name="search[fullName]" class="demoInputBox" value="<?php echo $fullName; ?>"/>

			<input type="submit" name="go" class="btnSearch" value="Search">
			<input type="reset" class="btnSearch" value="Reset" onclick="window.location='feedback.php'"></p>
			</div>
        ...
        <thead>
	      ...
	      <th><strong>User Inquiry</strong></th>
          ...
          <tr>
					...
					<td><?php echo $result[$k]["email"]; ?></td>
			 	    <td><?php echo $result[$k]["message"]; ?></td>
						<td>
						<a class="btnDeleteAction" href="deletefeedback.php?action=delete&contact_id=<?php echo $result[$k]["contactID"]; ?>" onclick="return confirm('Are you sure you want to delete this feedback?')">Delete</a>
						</td>
					</tr>
					<?php
						  }
