...
if(!empty($_POST["submit"])) {
    $query = "INSERT INTO toppings(topping_id,topping_name,price) VALUES ('10' ,'".$_POST["topping_name"]."','".$_POST["price"]."')";
...
<input type="text" name="topping_name" id="product_name" class="demoInputBox" value=""/>
<label style="padding-top:20px;">Price</label>
<span id="name-info" class="info"></span><br/>
<input type="text" name="price" id="price" class="demoInputBox" value=""/>
</div>
