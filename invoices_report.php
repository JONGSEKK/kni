	  ...
	  <div id="sales_report" class="float_r" style="margin-top: 100px">
			...
			<center>
        	  	<table width="680px" cellspacing="0" cellpadding="5">
                   	  <tr bgcolor="#46200B" >
                        <th align="center" style="color: #ffffff" width="140" >Invoice No.</th>
                       	<th style="color: #ffffff" width="179" align="center">Customer</th>
                   	  	<th style="color: #ffffff" width="134" align="center">Issue Date</th>
						 <center><th align="center" style="color: #ffffff" width="96" >Status</th></center>
					    <td width="79"></span>
              ...
              $sql = "SELECT CONCAT(C.customer_firstname,' ',C.customer_lastname)AS name,I.invoice_id,I.issue_date,I.status  FROM invoice I
              LEFT JOIN orders O
              ...
              if ($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                    ...
                    if($row["status"]==1)
                    {
                      ...
                      echo  "<tr>
                          	  <td><left>".$row["invoice_id"]."</left></td>
                           	<td><left>".$row["name"]."</left></td>
   							<td><left>".$row["issue_date"]."</leftr></td>
                               <td align='center'> <a class='btnEditAction' > ".$status." </a> </td>
   						</tr>";
                }
              } else {
